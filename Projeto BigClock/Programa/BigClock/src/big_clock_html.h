...
<!DOCTYPE html><html>
  ...
  <p><a href="/"><button class="button">DATA</button></a></p><br>
  <p><a href="/cron"><button class="button">CRONOMETRO</button></a></p><br>
  <p><a href="/"><button class="button">ALARME</button button2></a></p><br>
  <hr>
</html>
)=====";
